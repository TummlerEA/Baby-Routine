...
(async () => {
  ...
  const cases = [
    ...
    { day: 32, on: true,  kind: 'soon',  needs: 'starts about 12 September' },
    { day: 34, on: true,  kind: 'soon',  needs: 'starts about 12 September' },
    { day: 35, on: true,  kind: 'peak',  needs: 'at its worst about now' },
    { day: 39, on: true,  kind: 'peak',  needs: 'at its worst about now' },
    { day: 40, on: true,  kind: 'in',    needs: 'unsettled until roughly 19 September' },
    { day: 41, on: true,  kind: 'in',    needs: 'unsettled until roughly 19 September' },
    ...
    { day: 53, on: true,  kind: 'soon',  needs: '8-week leap starts about 3 October' },
    { day: 56, on: true,  kind: 'peak',  needs: 'at its worst about now' },
    { day: 62, on: true,  kind: 'in',    needs: 'unsettled until roughly 17 October' },
    { day: 65, on: true,  kind: 'in',    needs: 'unsettled until roughly 17 October' },
