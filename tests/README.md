...
| `test_journal.js` | 74 | The diary: the form filling itself from what is stored, a second save editing in place rather than adding a day, clearing a rating and clearing a day, editing an older one and cancelling out of it, the good/hard tallies at two window widths, the notes for a specialist, what the import refuses, the switch that keeps it out of the AI summary, and filling in a day that had no entry from the date field and from the strip, a day in the future refused, and the Russian. |
