...
226 checks over the app, in a browser, driven by Playwright.
...
| `test_smoke.js` | 28 | Log one of everything, open and close every screen, insist the console stayed silent. Knows almost nothing, catches almost everything. |
